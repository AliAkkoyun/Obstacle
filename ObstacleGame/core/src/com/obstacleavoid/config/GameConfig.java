...
public class GameConfig {
    ...
    public static final float HI_WIDTH = 480f;
    public static final float HI_HEIGHT = 800f;

    public static final float WORLD_CENTER_X = WORLD_WIDTH / 2f;
    public static final float  WORLD_CENTER_Y = WORLD_HEIGHT / 2.0f;

    public static final float OBSTACLE_SPAWN_TIME = 0.25f;
    public static final float MAX_PLAYER_X_SPEED = 0.25f;

    public static final int LIVES_START = 9999;
    public static final float SCORE_MAX_TIME = 1.25f;

    public static final float EASY_SPEED = 0.1f;
    public static final float MEDIUM_SPEED = 0.15f;
    public static final float HARD_SPEED = 0.18f;

    public static final float BETA_OBSTACLE_SPEED = 0.12f;
