...
public class DebugCameraConfig {
    ...
    private static final String MAZ_ZOOM_OUT = "maxZoomOut";
    ...
    private static final int DEFAULT_RESET_KEY =Input.Keys.B;
    ...
    private void load(){
        try{
            ...
            maxZoomOut = root.getFloat(MAZ_ZOOM_OUT,DEFAULT_MAX_ZOOM_OUT);
